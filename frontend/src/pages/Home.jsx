...
const CAT_IMGS = {
    "bancada-lavabo": "https://images.unsplash.com/photo-1584589167171-541ce45f1eea?w=1400&q=85&auto=format&fit=crop",
    organizacao: "https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=1400&q=85&auto=format&fit=crop",
    "mesa-receber": "https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=1400&q=85&auto=format&fit=crop",
    presentes: "https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?w=1400&q=85&auto=format&fit=crop",
};
    ...
    return (
        <div className="fade-in" data-testid="home-page">
            ...
            <section className="relative overflow-hidden" style={{ minHeight: "90vh" }}>
                <img
                    src="https://images.unsplash.com/photo-1584589167171-541ce45f1eea?w=2200&q=90&auto=format&fit=crop"
                    alt="Bancada de lavabo com bandeja e objetos Auré Casa"
                ...
                <div className="relative container-aure flex items-center" style={{ minHeight: "90vh", paddingTop: 120 }}>
                    <div className="max-w-2xl">
                        ...
                        <p className="text-xl mb-10 max-w-xl" style={{ color: "var(--aure-muted)", lineHeight: 1.6 }}>
            ...
            <section className="section-pad" style={{ background: "var(--aure-bg-2)" }}>
                <div className="container-aure">
                    <div className="max-w-2xl mb-16">
                        ...
                        <p className="text-lg" style={{ color: "var(--aure-muted)" }}>
            ...
            <section className="section-pad">
                <div className="container-aure grid md:grid-cols-2 gap-12 md:gap-24 items-center">
                    <div className="order-2 md:order-1">
                        ...
                        <p className="text-lg leading-relaxed mb-8" style={{ color: "var(--aure-muted)" }}>
                ...
                <section className="section-pad" style={{ background: "var(--aure-bg-2)" }}>
                    <div className="container-aure grid md:grid-cols-2 gap-12 md:gap-24 items-center">
                        <div className="relative">
                            <img
                                src="https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?w=1400&q=90&auto=format&fit=crop"
                                alt="Bowl Casca em mesa posta com pistaches"
                                style={{ borderRadius: 18, aspectRatio: "1", objectFit: "cover", width: "100%" }}
                            />
                            <div className="absolute bottom-6 left-6 px-4 py-2 rounded-full ui-label" style={{ background: "var(--aure-bg)", color: "var(--aure-ink)" }}>
                                Bowl Casca · Mostarda Suave
                            </div>
                        </div>
                        <div>
            ...
            <section className="section-pad">
                <div className="container-aure">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { title: "No lavabo", img: "https://images.unsplash.com/photo-1584589167171-541ce45f1eea?w=1400&q=85&auto=format&fit=crop" },
                            { title: "Na bancada", img: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1400&q=85&auto=format&fit=crop" },
                            { title: "No home office", img: "https://images.unsplash.com/photo-1617806118233-18e1de247200?w=1400&q=85&auto=format&fit=crop" },
                        ].map((c) => (
